...
func (s *S3Uploader) Run(_ context.Context, input interface{}, meta map[string]interface{}, _ string) (*TaskData[*string], error) {
	...
	return &TaskData[*string]{Data: nil, Metadata: meta}, nil
}
